...
exercise_type = {
  ...
  User.create(name: 'Rick', age: 40, height: 63, gender: 'Male', start_weight: 110, goal_weight: 130, start_date: '2017-01-01', goal_date: '2017-06-01', password: 'jacknife')
	...
	UserFood.create(user_id: 1, food_id: 1, calories: 201, date_eat: "2017-05-10")
	UserFood.create(user_id: 1, food_id: 2, calories: 50, date_eat: "2017-05-10")
	UserFood.create(user_id: 1, food_id: 3, calories: 52, date_eat: "2017-05-10")
	UserFood.create(user_id: 1, food_id: 4, calories: 158, date_eat: "2017-05-10")
	UserFood.create(user_id: 1, food_id: 5, calories: 18, date_eat: "2017-05-10")
	UserFood.create(user_id: 1, food_id: 6, calories: 116, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 1, calories: 201, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 2, calories: 50, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 3, calories: 52, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 4, calories: 158, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 5, calories: 18, date_eat: "2017-05-10")
	UserFood.create(user_id: 2, food_id: 6, calories: 116, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 1, calories: 201, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 2, calories: 50, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 3, calories: 52, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 4, calories: 158, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 5, calories: 18, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 6, calories: 116, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 1, calories: 201, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 2, calories: 50, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 3, calories: 52, date_eat: "2017-05-10")
	UserFood.create(user_id: 3, food_id: 4, calories: 158, date_eat: "2017-05-10")
  ...
  UserFood.create(user_id: 1, food_id: 6, calories: 116, date_eat: "2017-05-11")
  UserFood.create(user_id: 1, food_id: 5, calories: 18, date_eat: "2017-05-11")
  UserFood.create(user_id: 1, food_id: 4, calories: 158, date_eat: "2017-05-11")
  UserFood.create(user_id: 1, food_id: 3, calories: 52, date_eat: "2017-05-11")
  UserFood.create(user_id: 1, food_id: 1, calories: 201, date_eat: "2017-05-11")
  ...
  UserSleep.create(user_id: 1, calories: 816, duration: 12, sleep_date: "2017-05-14")
  UserSleep.create(user_id: 1, calories: 340, duration: 5, sleep_date: "2017-05-15")
  UserSleep.create(user_id: 1, calories: 408, duration: 6, sleep_date: "2017-05-16")
  UserSleep.create(user_id: 1, calories: 612, duration: 9, sleep_date: "2017-05-17")
  UserSleep.create(user_id: 1, calories: 340, duration: 5, sleep_date: "2017-05-18")
  UserSleep.create(user_id: 1, calories: 544, duration: 8, sleep_date: "2017-05-19")
  UserSleep.create(user_id: 1, calories: 544, duration: 8, sleep_date: "2017-05-20")
